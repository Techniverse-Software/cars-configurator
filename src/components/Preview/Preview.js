...
class Preview extends React.Component {
  ...
  get items() {
    this.props.models.map(model => console.log(this.props.config));
    return this.props.models.map(model => ({
      alt: model.name,
      url: `${process.env.PUBLIC_URL}/cars/model_${model.key}/model_${model.key}_${this.props.config.color}_${this.props.config.wheels}_${this.props.config.mirror}.png`,
